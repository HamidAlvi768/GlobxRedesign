...
?>
    ...
    <style>
        ...
        .gx-nav-links .nav-link sticky-nav-link{
            color: var(--text-dark) !important;
        }
        ...
        .gx-nav-links .nav-item.active .nav-link sticky-nav-link{
        ...
        .gx-nav-links .nav-item.active .nav-link sticky-nav-link.gx-chevron svg {
            color: var(--primary, #007bff) !important;
        }
    </style>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                <ul class="navbar-nav gx-nav-links">
                    <li class="nav-item <?php echo isNavActive('company', $currentPage) ? 'active' : ''; ?>">
                        <a class="nav-link sticky-nav-link<?php echo isNavActive('company', $currentPage) ? 'active gx-nav-active' : ''; ?>" href="./about-us.php">
                    ...
                    <li class="nav-item <?php echo isNavActive('services', $currentPage) ? 'active' : ''; ?>">
                        <a class="nav-link sticky-nav-link<?php echo isNavActive('services', $currentPage) ? 'active gx-nav-active' : ''; ?>" href="./excess-stock.php">
                    ...
                    <li class="nav-item <?php echo isNavActive('markets', $currentPage) ? 'active' : ''; ?>">
                        <a class="nav-link sticky-nav-link<?php echo isNavActive('markets', $currentPage) ? 'active gx-nav-active' : ''; ?>" href="./index.php#gx-markets-industries-section" data-anchor-target="gx-markets-industries-section">
                    ...
                    <li class="nav-item <?php echo isNavActive('products', $currentPage) ? 'active' : ''; ?>">
                        <a class="nav-link sticky-nav-link<?php echo isNavActive('products', $currentPage) ? 'active gx-nav-active' : ''; ?>" href="./products-main.php">
                    ...
                    <li class="nav-item <?php echo isNavActive('sell-excess', $currentPage) ? 'active' : ''; ?>">
                        <a class="nav-link sticky-nav-link<?php echo isNavActive('sell-excess', $currentPage) ? 'active gx-nav-active' : ''; ?>" href="./sell-excess-stock.php">
                            Sell Excess Stock
                        </a>
                    </li>
                    <li class="nav-item <?php echo isNavActive('contact', $currentPage) ? 'active' : ''; ?>">
                        <a class="nav-link sticky-nav-link<?php echo isNavActive('contact', $currentPage) ? 'active gx-nav-active' : ''; ?>" href="./contact.php">
                            Contact
                        </a>
                    </li>
                </ul>
