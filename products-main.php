            ...
            <div class="gx-featured-card">
              ...
              <div class="gx-featured-card-content">
                ...
                <div class="gx-featured-card-actions">
                  <a href="./product-detail.php" class="gx-featured-card-link-secondary">Explore More</a>
                  <a href="./pn-listing.php" class="gx-featured-card-link-primary">Show MPNs Only</a>
                </div>
              </div>
            </div>
